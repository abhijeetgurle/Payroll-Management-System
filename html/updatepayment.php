      ...
      <section id="main-content">
          <section class="wrapper">            
            ...
            <div class="panel-body">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="basic_salary" required>
                                </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-lg-10">
                                          <div class="row">
                                              <div class="col-lg-2">
                                                  <input type="text" class="form-control" name="payslip_no" required>
                                              </div>
                                              <label class="control-label col-lg-2" for="inputSuccess">Date Of Payment</label>
                                               <div class="col-lg-2">
                                                  <input type="text" class="form-control" name="date_of_payment" required>
                                              </div>
                                          </div>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-lg-10">
                                          <div class="row">
                                              <div class="col-lg-2">
                                                  <input type="text" class="form-control" name="DA" required>
                                              </div>
                                              <label class="control-label col-lg-2" for="inputSuccess">HRA</label>
                                               <div class="col-lg-2">
                                                  <input type="text" class="form-control" name="HRA" required>
                                              </div>
                                          </div>
                                      ...
                                      <div class="col-lg-10">
                                          <div class="row">
                                              <div class="col-lg-2">
                                               ...
                                               <div class="col-lg-2">
                                                  <input type="text" class="form-control" name="gratuity" required>
                                              </div>
                                          </div>
                                        </div>  
                                  </div>
