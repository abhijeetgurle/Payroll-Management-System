  ...
  <section id="container" class="">
      ...
      <section id="main-content">
          <section class="wrapper">            
              ...
              <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-laptop"></i> DELETE INFO</h3>
                    <ol class="breadcrumb">
                        <li><i class="fa fa-home"></i><a href="index.php">Home</a></li>
                        <li><i class="fa fa-laptop"></i>Delete Info</li>                          
                    </ol>
                </div>
            </div>

            <div class="panel-body">
            <form class="form-horizontal " method="post" action="updateemployee3.php" onsubmit="return validateForm()" name="myform1">
