          ...
          <section class="wrapper">            
              ...
              <div class="panel-body">
                        <div class="panel panel-primary">
                          <div class="panel-heading"><center><img src="img/logo_10.png" width=100% height=150></center></div>
                        </div> 
                        <br><br><br><br>
                        <div class="panel panel-success">
                          <div class="panel-heading"><center><font size=8 color=black>ABOUT ORIGIN</font></center></div>  
                          <br>
                          <div class="panel-content"><center><font size=5>ORIGIN IS FORMED WITH AN <font color="blue">OBJECTIVE TO SERVE</font> THE UNIQUE <font color="blue">MANAGEMENT NEEDS OF MODERN DAYS FACILITIES.</font></font></center></div>
                        </div>
                </div> 
               ...
               <div class="panel-body">
                        <br><br>
                        <div class="panel panel-success">
                          <div class="panel-heading"><center><font size=8 color=black>OUR MISSION</font></center></div>  
                          <br>
                          <div class="panel-content"><center><font size=5><b>PROVIDE A PRACTICAL SOLUTION TO OPTIMIZE THE ENERGY COST AND 'ZERO BREAK DOWN' SYSTEMS AT RIGHT COST</b></font></center></div>
                        </div>
                </div>                   
                <br><br><br>
            ...
            <div class="row">
				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
					<div class="info-box blue-bg">
						...
						<div class="title">Clients we've worked with</div>						
					</div><!--/.info-box-->			
				</div><!--/.col-->
				...
				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
					<div class="info-box brown-bg">
						...
						<div class="title">Energy Saving Project</div>						
					</div><!--/.info-box-->			
				</div><!--/.col-->	
            ...
            <div class="panel-body">
                        <div class="panel panel-primary">
                          <br>  
                          <div class="panel-heading"><font size=8><b>ORIGIN ELECTROTECH OFFERS PROFESSIONAL GUIDANCE FOR REDUCING THE COST OF ENERGY BILLS.</b></font></div>
                        </div>  
            </div>            
