            ...
            <form class="form-horizontal " method="post" action="updateemployee.php" onsubmit="return validateForm()" name="myform1">
              ...
              <div class="form-group">
                                      ...
                                      <div class="col-lg-10">
                                          ...
                                          <div class="radio">
                                              <label>
                                                  <input type="radio" name="optionsRadios" id="optionsRadios1" value="daily" checked>
                                                  Daily
                                              </label>
                                          </div>
                                          <div class="radio">
                                              <label>
                                                  <input type="radio" name="optionsRadios" id="optionsRadios2" value="monthly">
                                                  Monthly
                                              </label>
                                          </div>
              ...
              <div class="form-group">
                <label class="control-label col-lg-2" for="inputSuccess">Locations</label>
                  <div class="col-lg-10">
                    <select class="form-control m-bot15" name="location" required>
                      <option>Pune</option>
