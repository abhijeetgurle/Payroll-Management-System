...
if(isset($_POST['submit'])){
  $emp_id = $_POST['empid'];
  $emp_id = trim($emp_id);
  $sql = "DELETE FROM login WHERE empid='$emp_id'";
...
mysqli_close($link);
//header("Location: deleteaccount.php"); /* Redirect browser */
//exit();
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
          <section class="wrapper">            
              ...
              <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-laptop"></i> DELETE ACCOUNT</h3>
                    <ol class="breadcrumb">
                        <li><i class="fa fa-home"></i><a href="index.php">Home</a></li>
                        <li><i class="fa fa-laptop"></i>Delete Account</li>                          
                    </ol>
                </div>
            </div>

            <div class="panel-body">
            <form class="form-horizontal " method="post" action="deleteaccount.php" onsubmit="return validateForm()" name="myform1">
